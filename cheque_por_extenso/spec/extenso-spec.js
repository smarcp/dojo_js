...
describe('Teste para escrever cheques por extenso\n', function() {
    ...
    it('escrever valor 101', function(){
        ...
        var expectativa = 'cento e um'
        expect(expectativa).toEqual(converter.extenso(101))
    })

    it('escrever cheque no valor de 1158287,00', function() {

        var expectativa = 'um milhão e cento e cinquenta e oito mil e duzentos e oitenta e sete'
        expect(expectativa).toEqual(converter.extenso(1158287))
    });

    it('escrever cheque no valor de 50750287,00', function() {

        var expectativa = 'cinquenta milhões e setecentos e cinquenta mil e duzentos e oitenta e sete'
        expect(expectativa).toEqual(converter.extenso(50750287))
    });
